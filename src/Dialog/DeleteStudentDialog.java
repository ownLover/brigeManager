...
public class DeleteStudentDialog extends JDialog implements ActionListener{
	...
	public DeleteStudentDialog(JFrame owner)
	{
		...
		this.setModal(true);
		/*创建查询结果面板*/
		TableModel jTable1Model = new DefaultTableModel(new String[0][0] ,	new String[] { "编号", "姓名","桥梁","桥梁巡查结果" });
		jTable1 = new JTable();
 ...
 public void actionPerformed(ActionEvent e) {
	DefaultTableModel tm = new DefaultTableModel(new String[0][0] ,	new String[] { "编号", "姓名","桥梁","桥梁巡查结果" });
	jTable1.setModel(tm);
		if(e.getSource()==query1)
		{
		   ...
		   try{ 
			 ...
			 String s="select * from users where userid='"+id+"' and usertype='巡查员'";
			...
			try{
			   ...
			   try{ 
				 ...
				 sql.execute(s);
				 sql.execute(str);
				 JOptionPane.showMessageDialog(null, "巡查员信息删除成功！");
				 sql.close();
				 con.close(); 
				   }
				catch(SQLException a)
