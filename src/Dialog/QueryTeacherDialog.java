...
public class QueryTeacherDialog extends JDialog implements ActionListener{
	...
	public QueryTeacherDialog(JFrame owner)
	{
		...
		this.setModal(true);
		/*创建查询结果面板*/
		TableModel jTable1Model = new DefaultTableModel(new String[0][0] ,	new String[] { "工号", "姓名","桥梁","桥梁巡查" });
		jTable1 = new JTable();
 ...
 public void actionPerformed(ActionEvent e) {
	DefaultTableModel tm = new DefaultTableModel(new String[0][0] ,	new String[] { "工号", "姓名","桥梁","桥梁巡查"});
	jTable1.setModel(tm);
