...
public class DeleteTeacherDialog extends JDialog implements ActionListener{
	...
	public DeleteTeacherDialog(JFrame owner)
	{
		...
		this.setModal(true);
		/*创建查询结果面板*/
		TableModel jTable1Model = new DefaultTableModel(new String[0][0] ,	new String[] { "工号", "姓名","桥梁","桥梁巡查结果" });
		jTable1 = new JTable();
 ...
 public void actionPerformed(ActionEvent e) {
	DefaultTableModel tm = new DefaultTableModel(new String[0][0] ,	new String[] { "工号", "姓名","桥梁","桥梁巡查结果" });
	jTable1.setModel(tm);
		if(e.getSource()==query1)
		{
		   ...
		   try{ 
			 ...
			 String s="select * from users where userid='"+id+"' and usertype ='管理员'";
			...
			try{
			   ...
			   try{ 
				 ...
				 sql.execute(s);
				 JOptionPane.showMessageDialog(null, "管理员信息删除成功！");
				 con.close(); 
				   }
				catch(SQLException a)
				{
